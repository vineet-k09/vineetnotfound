...
export default function CustomCursor() {
	...
	return (
		<>
			<motion.div className="z-[9999] hidden sm:block fixed bottom-4 left-20 font-mono text-sm">
				{visibleX}
			</motion.div>
			<motion.div className="z-[9999] hidden sm:block fixed top-60 rotate-90 font-mono text-sm">
				{visibleY}
			</motion.div>
			{/* Lasso Circle */}
			<motion.div
