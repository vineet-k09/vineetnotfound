			...
			<div className="max-w-6xl mx-auto px-6 sm:px-12 flex flex-col gap-12 relative z-10">
				...
				<div className="grid grid-cols-1 md:grid-cols-12 gap-10">
					...
					<div className="md:col-span-5 flex flex-col gap-4">
						...
						<p
							className={`text-xs leading-relaxed font-body max-w-sm ${
					...
					<div className="md:col-span-3 flex flex-col gap-3">
						...
						<ul
							className={`flex flex-col gap-2.5 font-nav text-xs tracking-[0.15em] font-medium uppercase ${
								isDark ? "text-neutral-400" : "text-slate-700"
							}`}>
							<li>
								<a
									...
									<span>GITHUB</span>
									<span className="font-mono text-[10px] text-slate-400 group-hover:text-rose-600 transition-colors">
										↗
									</span>
								</a>
							</li>
				...
				<div
					className={`pt-8 border-t flex flex-col sm:flex-row items-center justify-between gap-4 font-nav text-xs tracking-[0.15em] uppercase ${
						isDark
							...
							: "border-[#d4cebe] text-slate-600 font-medium"
					}`}>
					<div>
						<span>
					...
					<button
						...
						className={`spider-cut-sm px-4 py-2 flex items-center gap-2 transition-all cursor-pointer border ${
							isDark
								...
								: "bg-white hover:bg-rose-600 hover:text-white text-slate-900 border-[#d4cebe] font-bold pop-shadow-light"
						}`}>
